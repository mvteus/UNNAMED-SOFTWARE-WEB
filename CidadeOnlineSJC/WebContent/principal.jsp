...
<body>
    ...
    <header id="top" class="header">
        ...
        <div class="text-vertical-center">
            <img class="img-responsive btn" src="http://placehold.it/200x200&amp;text=Logo" alt="">
            <h1>Cidade Online</h1>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-10 col-lg-offset-1 text-center">
                    <h4><strong>ACI</strong>
                    </h4>
                    <p>Afonso Pena<br>São José dos Campos</p>
                    <ul class="list-unstyled">
                        
                        <li><i class="fa fa-envelope-o fa-fw"></i>  <a href="mailto:name@example.com">aci@empresa.com</a>
                        </li>
                    </ul>
                    <br>
