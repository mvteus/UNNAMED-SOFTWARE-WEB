        ...
        <nav class="navbar navbar-default  navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    <li>
                        <a href="principal.html"><i class="fa fa-fw fa-dashboard"></i> Pagina Inicial</a>
                    </li>
                    ...
                    <li>
                        ...
                        <ul id="demo" class="collapse">
                            ...
                            <li>
                                <a href="forms.html"><i class="fa fa-fw fa-edit"></i> Deletar Empresa</a>
                            </li>
                        </ul>
                    </li>
                    
                    <li>
                        <a href="categoria.jsp"><i class="fa fa-fw fa-edit"></i> Catetoria</a>
                    </li>
                   
                   	<li>
                        <a href="loja.jsp"><i class="fa fa-fw fa-shop"></i> Loja</a>
                    </li>
